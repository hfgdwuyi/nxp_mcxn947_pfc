...
#define SS_RLY_EN_GPIO          GPIO0
#define SS_RLY_EN_GPIO_PIN 5
#define PFC1_EN_GPIO            GPIO0
#define PFC1_EN_GPIO_PIN 6
#define PFC2_EN_GPIO            GPIO0
#define PFC2_EN_GPIO_PIN 7
#define DCDC1_EN_GPIO            GPIO0
#define DCDC1_EN_GPIO_PIN 10
#define DCDC2_EN_GPIO            GPIO0
#define DCDC2_EN_GPIO_PIN 11
#define DBG_LED_GPIO                GPIO3
#define DBG_LED0_PIN 10
#define DBG_LED1_PIN 11
#define DBG_LED2_PIN 12
#define CAN_LED_GPIO                GPIO1
#define CAN_LED_RUN_PIN 12
#define CAN_LED_ERROR_PIN 13
#define PWM1_GPIO            GPIO2
#define PWM1_GPIO_PIN 0
#define PWM2_GPIO            GPIO2
#define PWM2_GPIO_PIN 1
#define PWM3_GPIO            GPIO2
#define PWM3_GPIO_PIN 7


#define PFC1_FLT_GPIO            GPIO0
#define PFC1_FLT_GPIO_PIN 8
#define PFC2_FLT_GPIO            GPIO0
#define PFC2_FLT_GPIO_PIN 9
#define SYS_CFG0_GPIO            GPIO0
#define SYS_CFG0_GPIO_PIN 2
#define SYS_CFG1_GPIO            GPIO0
#define SYS_CFG1_GPIO_PIN 3
#define SYS_CFG2_GPIO            GPIO0
#define SYS_CFG2_GPIO_PIN 4

#define PWM1_FB_GPIO            GPIO2
#define PWM1_FB_GPIO_PIN 8
#define PWM2_FB_GPIO            GPIO2
#define PWM2_FB_GPIO_PIN 9
#define PWM3_FB_GPIO            GPIO2
#define PWM3_FB_GPIO_PIN 10
...
/* Display. */
#define BOARD_LCD_CS_GPIO GPIO1//GPIO3
#define BOARD_LCD_CS_GPIO_PIN 14U//5U
...
#define BOARD_LCD_RESET_GPIO GPIO3
#define BOARD_LCD_RESET_GPIO_PIN 4U
#define LCD_RESET_LOW()     GPIO_PortClear(BOARD_LCD_RESET_GPIO, 1U << BOARD_LCD_RESET_GPIO_PIN)
#define LCD_RESET_HIGH()    GPIO_PortSet(BOARD_LCD_RESET_GPIO, 1U << BOARD_LCD_RESET_GPIO_PIN)

#define BOARD_LCD_RS_GPIO GPIO1//GPIO3
#define BOARD_LCD_RS_GPIO_PIN 15U//6U
#define LCD_RS_LOW()     GPIO_PortClear(BOARD_LCD_RS_GPIO, 1U << BOARD_LCD_RS_GPIO_PIN)
#define LCD_RS_HIGH()    GPIO_PortSet(BOARD_LCD_RS_GPIO, 1U << BOARD_LCD_RS_GPIO_PIN)

#define BOARD_LCD_SDA_GPIO GPIO3
#define BOARD_LCD_SDA_GPIO_PIN 2U
#define LCD_SDA_LOW()     GPIO_PortClear(BOARD_LCD_SDA_GPIO, 1U << BOARD_LCD_SDA_GPIO_PIN)
#define LCD_SDA_HIGH()    GPIO_PortSet(BOARD_LCD_SDA_GPIO, 1U << BOARD_LCD_SDA_GPIO_PIN)

#define BOARD_LCD_SCL_GPIO GPIO3
#define BOARD_LCD_SCL_GPIO_PIN 3U
#define LCD_SCL_LOW()     GPIO_PortClear(BOARD_LCD_SCL_GPIO, 1U << BOARD_LCD_SCL_GPIO_PIN)
#define LCD_SCL_HIGH()    GPIO_PortSet(BOARD_LCD_SCL_GPIO, 1U << BOARD_LCD_SCL_GPIO_PIN)


#define BOARD_LCD_ROM_IN_GPIO GPIO3
#define BOARD_LCD_ROM_IN_GPIO_PIN 21U
#define LCD_ROM_IN_LOW()     GPIO_PortClear(BOARD_LCD_ROM_IN_GPIO, 1U << BOARD_LCD_ROM_IN_GPIO_PIN)
#define LCD_ROM_IN_HIGH()    GPIO_PortSet(BOARD_LCD_ROM_IN_GPIO, 1U << BOARD_LCD_ROM_IN_GPIO_PIN)

#define BOARD_LCD_ROM_OUT_GPIO        GPIO3
#define BOARD_LCD_ROM_OUT_GPIO_PIN    19U
#define ROM_OUT GPIO_PinRead(BOARD_LCD_ROM_OUT_GPIO, BOARD_LCD_ROM_OUT_GPIO_PIN)

#define BOARD_LCD_ROM_SCK_GPIO GPIO3
#define BOARD_LCD_ROM_SCK_GPIO_PIN 17U
#define LCD_ROM_SCK_LOW()     GPIO_PortClear(BOARD_LCD_SDA_GPIO, 1U << BOARD_LCD_ROM_SCK_GPIO_PIN)
#define LCD_ROM_SCK_HIGH()    GPIO_PortSet(BOARD_LCD_SDA_GPIO, 1U << BOARD_LCD_ROM_SCK_GPIO_PIN)

#define BOARD_LCD_ROM_CS_GPIO GPIO3
#define BOARD_LCD_ROM_CS_GPIO_PIN 18U
#define LCD_ROM_CS_LOW()     GPIO_PortClear(BOARD_LCD_SCL_GPIO, 1U << BOARD_LCD_ROM_CS_GPIO_PIN)
#define LCD_ROM_CS_HIGH()    GPIO_PortSet(BOARD_LCD_SCL_GPIO, 1U << BOARD_LCD_ROM_CS_GPIO_PIN)
